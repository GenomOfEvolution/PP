...
static void TryBMPv1(std::ifstream& input, InfoHeader& infoHeader, int bitsOnColor, int maskValue)
{
...
static void TryBMPv2(std::ifstream& input, InfoHeader& infoHeader, int bitsOnColor, int maskValue)
{
...
static void TryBMPv3(std::ifstream& input, InfoHeader& infoHeader, int bitsOnColor, int maskValue)
{
...
static void TryBMPv4(std::ifstream& input, InfoHeader& infoHeader)
{
...
static void TryBMPv5(std::ifstream& input, InfoHeader& infoHeader)
{
...
static bool IsFormatSupported(const InfoHeader& infoHeader)
{
